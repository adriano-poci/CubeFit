...
def main():
    ...
    os.environ["CUBEFIT_LAMBDA_MIX"] = str(1e-4)
    os.environ["CUBEFIT_LAMBDA_ASMOOTH"] = str(0.0) # small non-zero
    os.environ["CUBEFIT_LAMBDA_FLAT"] = str(1e-4)
    os.environ["CUBEFIT_LAMBDA_FLAT_MAX_SCALE"] = str(5e4)
    os.environ["CUBEFIT_LAMBDA_L1"] = str(1e-4)
    os.environ["CUBEFIT_LAMBDA_L2"] = str(1e-6)
